...
//  FlappyBird
//
//  Created by Haesong Lee on 3/7/17.
//
...
class FlappyScene: SKScene {
    ...
    static let birdCategory: UInt32 = 1
    static let obstacleCategory: UInt32 = 2
    static let scoreCategory: UInt32 = 4
    ...
    private let birdNode: SKSpriteNode = {
        ...
        birdNode.physicsBody?.collisionBitMask = UInt32.max ^ 4
    ...
    func setUpPipes(){
        ...
        let movesPipesForeverAction = SKAction.repeatForever(movesPipesAction)
        pipePair.run(movesPipesForeverAction)
